...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" data-widget="pushmenu" href="starter" role="button"><i class="fas fa-bars"></i></a>
        </li>
        <li class="nav-item d-sm-inline-block">
          <a href="starter" class="nav-link">Home</a>
        </li>
        <li class="nav-item d-sm-inline-block">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="starter" class="d-block"> <?php echo $_SESSION['login'] ?></a>
          </div>
        </div>
...
?>
            <li id="<?php echo $ver_acessos['menu_name'] ?>" class="nav-item menu-close">
              <a id="<?php echo $ver_acessos['menu_name'] ?>nav-link_menu" class="nav-link" >
            ...
            foreach ($ver_acessos_name as $key => $name):
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item" >
                  <a id="<?php echo $name ?>" href="<?php echo $name ?>" class="nav-link">
              ...
              <title><?php echo($menu_sep[$key]) ?></title>
              <?php
              endforeach;
              ?>
            </li>
